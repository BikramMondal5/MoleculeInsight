...
const features = [
    ...
    },
    {
        ...
        description: "Experience molecules like never before with our interactive 3D viewer. Rotate, zoom, and analyze molecular structures in high fidelity to gain deeper spatial understanding and structural insights.",
        icon: Users,
        align: "left",
        video: "/3D-Molecular-Visualization.mp4"
    },
]
